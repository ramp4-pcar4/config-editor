import{t as e}from"./glsl-EDZkDhgF-YpsCyUYs.js";import{t}from"./FloatPassUniform-gHcGW-mi-InQ2t8Dl.js";import{t as n}from"./Texture2DBindUniform-BjIiNL3v-DroCPIik.js";import{t as r}from"./FloatBindUniform-avAg5yxD-Gs1wGvCX.js";import{i,n as a,r as o,t as s}from"./View.glsl-YsNDLcX0-CjGrhnxM.js";import{n as c,r as l}from"./ScreenSizePerspective.glsl-Dmu3eZ8--BQz6wwBu.js";import{n as u}from"./VerticalOffset.glsl-BXr3ZmRy-Ce9SLfjg.js";import{t as d}from"./BooleanBindUniform-Dh7KRyL2-F8nRxisu.js";import{t as f}from"./Float4BindUniform-BljimXR4-BtyWLWFr.js";var p=.5;function m(n,d){n.include(c),n.attributes.add(`position`,`vec3`),n.attributes.add(`normal`,`vec3`),n.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=n.vertex;a(p,d),s(p,d),p.uniforms.add(new f(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new r(`aboveGround`,e=>e.camera.aboveGround?1:-1)),d.hasVerticalOffset&&u(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
