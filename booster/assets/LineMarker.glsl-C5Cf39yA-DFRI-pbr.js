import{t as e}from"./ShaderBuilder-aUMFb5cS-D2OCjrzz.js";import{n as t,t as n}from"./glsl-EDZkDhgF-YpsCyUYs.js";import{t as r}from"./Texture2DPassUniform-RVTT2Sjh-CZfOgZ9L.js";import{a as i,r as a,t as o}from"./AlphaCutoff-lGKpUdxr-B7eCn2-f.js";import{t as s}from"./Float4PassUniform-R_rVPKlL-u0XYS7xz.js";import{t as c}from"./FloatBindUniform-avAg5yxD-Gs1wGvCX.js";import{t as l}from"./Matrix4BindUniform-gJm9vWnt-qDRXgYLM.js";import{i as u,n as d,r as f}from"./View.glsl-YsNDLcX0-CjGrhnxM.js";import{t as p}from"./Float2BindUniform-DpaMSVXH-C_hNhflU.js";import{t as m}from"./TerrainDepthTest.glsl-DZ7tKbZj-B76V56mr.js";import{t as h}from"./OutputColorHighlightOLID.glsl-vs7-ar26-DvrWbQfE.js";import{t as g}from"./Float4BindUniform-BljimXR4-BtyWLWFr.js";import{i as _,o as v,s as y,t as b}from"./MarkerSizing.glsl-D6DTpnXO-BHt8ooCn.js";import{t as x}from"./PositionOutsideClipSpace-I4C860lT-C5cY6pxd.js";function S(S){let C=new e,{space:w,anchor:T,hasTip:E,hasScreenSizePerspective:D}=S,O=w===2,k=w===1;C.include(y,S),C.include(v,S),C.include(m,S);let{vertex:A,fragment:j,varyings:M}=C;d(A,S),C.attributes.add(`position`,`vec3`),C.attributes.add(`previousDelta`,`vec4`),C.attributes.add(`uv0`,`vec2`),M.add(`vColor`,`vec4`),M.add(`vpos`,`vec3`,{invariant:!0}),M.add(`vUV`,`vec2`),M.add(`vSize`,`float`),E&&M.add(`vLineWidth`,`float`),A.uniforms.add(new p(`nearFar`,({camera:e})=>e.nearFar),new g(`viewport`,({camera:e})=>e.fullViewport)).code.add(n`vec4 projectAndScale(vec4 pos) {
