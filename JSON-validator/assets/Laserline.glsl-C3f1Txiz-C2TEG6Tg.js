import{t as e}from"./glsl-EDZkDhgF-CdQT_T3M.js";import{t}from"./Float3PassUniform-BEhcqx4m-Gsj9_0jU.js";import{t as n}from"./FloatPassUniform-gHcGW-mi-C4YRZdNT.js";import{t as r}from"./Texture2DPassUniform-RVTT2Sjh-DNHX-w6c.js";import{t as i}from"./ReadDepth.glsl--9xefl90-INkDkhEi.js";import{t as a}from"./Texture2DBindUniform-BjIiNL3v-Bmij0LYy.js";import{t as o}from"./CameraSpace.glsl-DSKPuMcP-BT5mEqB0.js";function s(e){e.code.add(`
  vec4 blendColorsPremultiplied(vec4 source, vec4 dest) {
    float oneMinusSourceAlpha = 1.0 - source.a;
    return source + dest * oneMinusSourceAlpha;
  }
  `)}function c(c,l){let u=c.fragment;u.include(i),c.include(o),u.include(s),u.uniforms.add(new n(`globalAlpha`,e=>e.globalAlpha),new t(`glowColor`,e=>e.glowColor),new n(`glowWidth`,(e,t)=>e.glowWidth*t.camera.pixelRatio),new n(`glowFalloff`,e=>e.glowFalloff),new t(`innerColor`,e=>e.innerColor),new n(`innerWidth`,(e,t)=>e.innerWidth*t.camera.pixelRatio),new a(`depthMap`,e=>e.depth?.attachment),new r(`normalMap`,e=>e.normals)),u.code.add(e`vec4 premultipliedColor(vec3 rgb, float alpha) {
