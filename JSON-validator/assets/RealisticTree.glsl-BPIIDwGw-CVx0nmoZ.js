import{t as e}from"./ShaderBuilder-qfzG-N7a-_MHxoFkL.js";import{n as t,t as n}from"./glsl-EDZkDhgF-CdQT_T3M.js";import{t as r}from"./Float3PassUniform-BEhcqx4m-Gsj9_0jU.js";import{t as i}from"./FloatPassUniform-gHcGW-mi-C4YRZdNT.js";import{t as a}from"./Texture2DPassUniform-RVTT2Sjh-DNHX-w6c.js";import{c as o,r as s}from"./Emissions.glsl-C1fRgyHC-CN8fg_VD.js";import{n as c,t as l}from"./AlphaCutoff-CYKfZXRg-DXT1fwYN.js";import{t as u}from"./Float4PassUniform-R_rVPKlL-CftqlLOj.js";import{a as d,n as f,r as p}from"./VisualVariables.glsl-DLFsc7-1-5W9ja1Pl.js";import{n as m,t as h}from"./View.glsl-DtKDkY_h-CX2rKRzP.js";import{t as g}from"./TerrainDepthTest.glsl-D0F_r5xM-CwcBX4pv.js";import{t as _}from"./OutputColorHighlightOLID.glsl-DuYrVBF1-Dc5MS-j7.js";import{r as v}from"./Transform.glsl-B8LYsJdc-DxbZLP5s.js";import{t as y}from"./VertexColor.glsl-DkZ0DT-i-BjUQZ0y1.js";import{a as b}from"./MaterialUtil-CTR37o33-jKCCN6En.js";import{t as x}from"./MixExternalColor.glsl-uNucrwe0-BHO2PAWk.js";import{r as S}from"./VerticalOffset.glsl-CpSd_uMO-BQVbjjVa.js";import{a as C,d as w,n as T,r as E,t as D}from"./ReadShadowMap.glsl-dCXMBZ4w-vIYJ2U3i.js";import{c as O,d as k,i as A,l as j,t as ee,u as M}from"./SnowCover.glsl-wYbF-EO9-DG6-d2KM.js";import{c as N,i as P,l as F,n as I,r as L,t as R,u as z}from"./DefaultMaterialAuxiliaryPasses.glsl-DzmFvfsX-BnLGW0yn.js";function B(B){let V=new e,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(m(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(d,B),V.include(P,B),V.include(S,B),V.include(g,B),!o(K))return V.include(F,B),V;h(V.vertex,B),V.include(I,B),V.include(v),q&&V.include(z),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(s,B),V.include(N,B),V.include(R,B),V.include(y,B),U.include(p),U.include(f),U.uniforms.add(new u(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?E:T,B),U.main.add(n`
    forwardVertexColor();
