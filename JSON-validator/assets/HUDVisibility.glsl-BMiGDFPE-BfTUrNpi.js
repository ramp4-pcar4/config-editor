import{t as e}from"./glsl-EDZkDhgF-CdQT_T3M.js";import{t}from"./FloatPassUniform-gHcGW-mi-C4YRZdNT.js";import{t as n}from"./Texture2DBindUniform-BjIiNL3v-Bmij0LYy.js";import{t as r}from"./FloatBindUniform-avAg5yxD-gNZ2L0Wp.js";import{i,n as a,r as o,t as s}from"./View.glsl-DtKDkY_h-CX2rKRzP.js";import{t as c}from"./Float4BindUniform-BljimXR4-p2Hchggp.js";import{n as l,r as u}from"./ScreenSizePerspective.glsl-Dmu3eZ8--BDfsza-R.js";import{n as d}from"./VerticalOffset.glsl-CpSd_uMO-BQVbjjVa.js";import{t as f}from"./BooleanBindUniform-Dh7KRyL2-BVneiOI0.js";var p=.5;function m(n,f){n.include(l),n.attributes.add(`position`,`vec3`),n.attributes.add(`normal`,`vec3`),n.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=n.vertex;a(p,f),s(p,f),p.uniforms.add(new c(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new r(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
...
float absCosAngle;
  ...
  `),f.draped&&!f.hasVerticalOffset||i(p),f.draped||(p.uniforms.add(new r(`perDistancePixelRatio`,e=>Math.tan(e.camera.fovY/2)/(e.camera.fullViewport[2]/2))),p.code.add(e`
    ...
    `)),f.screenCenterOffsetUnitsEnabled&&o(p),f.hasScreenSizePerspective&&u(p),p.code.add(e`
...
vec2 result = (ij * 2.0 - vec2(1.0)) * clipCoord.w;
return vec4(result, clipCoord.zw);
}`)}function g(t){t.vertex.uniforms.add(new r(`renderTransparentlyOccludedHUD`,e=>e.hudRenderStyle===0?1:e.hudRenderStyle===1?0:.75),new c(`viewport`,e=>e.camera.fullViewport),new n(`hudVisibilityTexture`,e=>e.hudVisibility?.getTexture())),t.vertex.include(h),t.vertex.code.add(e`bool testHUDVisibility(vec4 posProj) {
