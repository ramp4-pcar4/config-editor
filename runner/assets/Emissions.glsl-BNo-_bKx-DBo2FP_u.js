import{Uk as e}from"./main-B1TNKY4t.js";import{n as t,t as n}from"./glsl-BgsHvHfn-CIx088aE.js";function r(t){t.constants.add(`GAMMA`,`float`,e).constants.add(`INV_GAMMA`,`float`,1/e).code.add(n`vec3 delinearizeGamma(vec3 color) {
