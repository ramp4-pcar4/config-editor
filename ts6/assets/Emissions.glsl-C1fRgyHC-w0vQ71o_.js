import{pw as e}from"./main-oTxL539D.js";import{n as t,t as n}from"./glsl-EDZkDhgF-DQc70waf.js";function r(t){t.constants.add(`GAMMA`,`float`,e).constants.add(`INV_GAMMA`,`float`,1/e).code.add(n`vec3 delinearizeGamma(vec3 color) {
