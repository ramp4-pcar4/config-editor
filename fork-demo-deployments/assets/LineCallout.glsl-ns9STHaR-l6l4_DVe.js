import{Cs as e,Ms as t,dC as n}from"./main-B1TNKY4t.js";import{t as r}from"./ShaderBuilder-Dy-kUWY5-CiPIRO_O.js";import{n as i,t as a}from"./glsl-BgsHvHfn-CIx088aE.js";import{g as o}from"./Emissions.glsl-BNo-_bKx-DBo2FP_u.js";import{Bt as s,Cn as c,Ht as l,On as u,Q as d,Ut as f,X as p,gn as m,xt as h}from"./FloatArray-CCh0HzKA--k3dBsyW.js";import{G as g,K as _,q as v}from"./HUDMaterial-CJpF-x0h-XSjxVnr3.js";function y(e){e.include(l),e.uniforms.add(new u(`geometryDepthTexture`,e=>e.geometryDepth?.attachment)),e.code.add(a`bool geometryDepthTest(vec2 pos, float elementDepth) {
float geometryDepth = linearDepthFromTexture(geometryDepthTexture, pos);
return (elementDepth < (geometryDepth - 1.0));
}`)}function b(t){let l=new r,{vertex:u,fragment:b}=l,{terrainDepthTest:C}=t;return u.include(_),l.include(v,t),l.vertex.include(c,t),t.hudDepth||l.include(s,t),l.attributes.add(`uv0`,`vec2`),u.uniforms.add(new d(`viewport`,e=>e.camera.fullViewport),new o(`lineSize`,(e,t)=>e.size>0?Math.max(1,e.size)*t.camera.pixelRatio:0),new f(`pixelToNDC`,e=>n(S,2/e.camera.fullViewport[2],2/e.camera.fullViewport[3])),new o(`borderSize`,(e,t)=>e.borderColor?t.camera.pixelRatio:0),new p(`screenOffset`,(e,t)=>n(S,e.horizontalScreenOffset*t.camera.pixelRatio,0))),l.varyings.add(`coverageSampling`,`vec4`),l.varyings.add(`lineSizes`,`vec2`),C&&l.varyings.add(`depth`,`float`),t.useVisibilityPixel&&l.include(g),t.hasScreenSizePerspective&&h(u),u.main.add(a`
    ...
    gl_Position = projectedPosition;`),b.uniforms.add(new m(`uColor`,t=>t.color??e),new m(`borderColor`,t=>t.borderColor??e)),C&&(b.include(y,t),b.uniforms.add(new f(`inverseViewport`,e=>e.inverseViewport))),b.main.add(a`
