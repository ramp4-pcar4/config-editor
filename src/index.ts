                    ...
                    tileSchemas: [
                        {
                            ...
                            thumbnailTileUrls: ['/tile/8/285/268', '/tile/8/285/268'],
                            hasNorthPole: true,
                            recoveryBasemap: {
                    ...
                    basemaps: [
                        {
                            ...
                            attribution: {
                                text: {
                                    disabled: false,
                                    value: '© His Majesty the King in Right of Canada, as represented by the Minister of Natural Resources Canada'
                                },
                                logo: {
                                    disabled: false
                                }
                        ...
                        },
                        {
                            ...
                            thumbnailUrl: 'assets/images/outline.png',
                            layers: [
                                {
                                    id: 'provinces_3978',
                                    layerType: 'esri-tile',
                    ...
                    basemaps: [
                        {
                            ...
                            attribution: {
                                text: {
                                    disabled: false,
                                    value: '© Sa Majesté le Roi du chef du Canada, représenté par le ministre de Ressources naturelles Canada'
                                },
                                logo: {
                                    disabled: false
                                }
