<template>
    <div>
        ...
        <p class="mt-4 text-sm text-gray-600">{{ t('wizard.extent.description') }}</p>

        <div class="mt-16 space-y-4">
            <!-- Mercator -->
            <section class="rounded-xl border border-gray-200 bg-white p-16">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <div class="text-sm font-medium text-gray-900">{{ t('wizard.extent.mercator') }}</div>
                        <div class="mt-4 text-xs text-gray-500">{{ MERCATOR_EXTENT_SET_ID }}</div>
                    </div>

                    <button
                        type="button"
                        class="rounded-lg border border-gray-300 px-12 py-8 text-sm text-gray-700 transition hover:bg-gray-50"
                ...
                <div class="mt-16 grid grid-cols-1 gap-4 ce-md:grid-cols-2">
                    <div class="grid gap-2">
                        <label class="text-sm font-medium text-gray-900">xmin</label>
                        <input
                            v-model.number="mercatorDefault.xmin"
                            type="number"
                            class="w-full rounded-lg border border-gray-300 px-12 py-8 text-sm outline-none transition focus:border-gray-400"
                        />
                    </div>
            ...
            <section class="rounded-xl border border-gray-200 bg-white p-16">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <div class="mt-4 text-xs text-gray-500">{{ LAMBERT_EXTENT_SET_ID }}</div>
                    </div>
