<template>
    <div class="ramp4-config-editor">
        <button @click="isWizardOpen = true">Open Quick Start Wizard</button>
...
import { ref } from 'vue';
import WizardModal from './wizard-modal.vue';
...
const onWizardCancel = () => {
    // optional: keep draftWizardState so they can resume
};
</script>
