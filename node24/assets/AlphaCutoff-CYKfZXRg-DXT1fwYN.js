import{E as e}from"./typedArrayUtil-DYSyCOD_-DIvTpH0Q.js";import{y as t}from"./Error-D4B15biX-BEtbr5nu.js";import{n}from"./tslib.es6-D23imAM7-C50a1nFc.js";import{f as r,r as i}from"./vec3f64-CG5ySZkG-By_GZpBl.js";import{t as a}from"./mat4f64-B3SVWMa--MixLv9i_.js";import{h as o}from"./mat4-D0YTl6eA-WzEyXVd2.js";import{A as s,D as c,s as l,v as u}from"./vec3-D0JSMCWt-Cr-29W6p.js";import{t as d}from"./glsl-EDZkDhgF-CdQT_T3M.js";import{t as f}from"./Uniform-Dp2mgLmf-j3oXE9Ng.js";import{t as p}from"./Float3DrawUniform-CLaN-1NK-By_SeKJC.js";import{t as m}from"./NoParameters-DvFAVXX5-D4-4keqN.js";import{t as h}from"./Texture2DBindUniform-BjIiNL3v-Bmij0LYy.js";import{t as g}from"./HighlightReadBitmap.glsl-O45u9_r0-CgwZV4hs.js";var _=class{constructor(e){this._bits=[...e]}equals(t){return e(this._bits,t.bits)}get code(){return this._code??=String.fromCharCode(...this._bits),this._code}get bits(){return this._bits}},v=class extends m{constructor(){super(),this._parameterBits=this._parameterBits?.map(()=>0)??[],this._parameterNames??=[]}get key(){return this._key??=new _(this._parameterBits),this._key}decode(e=this.key){let t=this._parameterBits;this._parameterBits=[...e.bits];let n=this._parameterNames.map(e=>`    ${e}: ${this[e]}`).join(`
...
return false;
}`):n.uniforms.add(new h(`depthTexture`,e=>e.mainDepth)).code.add(d`bool isHighlightOccluded() {
